...
export function FinancePage() {
  ...
  function removeInvoiceLine(lineId) {
    const confirmed = window.confirm("Remove this supplier invoice line from the workspace?");
    if (!confirmed) return;
  ...
  return (
    <>
      <PageHeader eyebrow="Finance" title="Finance & dispensary profitability engine">
        ...
        alerts. the workflow is now closer to
        a usable product.
      </PageHeader>
      ...
      <section className="content-grid">
        <Panel className="panel panel-large">
          <SectionHeader eyebrow="Dispensary" title="GPP vs supplier cost matching">
            This table compares GPP/reimbursement lines against supplier
      ...
      <section className="content-grid">
        <Panel className="panel panel-large">
          <SectionHeader eyebrow="Supplier invoices" title="Manual invoice line entry">
            This is the workspace version of the future invoice uploader. For now,
      ...
      <section className="content-grid">
        ...
        <Panel className="panel">
          <SectionHeader eyebrow="Overview" title="Monthly position">
            Local management summary for the selected finance period.
          </SectionHeader>
      ...
      <section className="content-grid">
        <Panel className="panel">
          <SectionHeader eyebrow="Budgets" title="Wage and budget allocation">
            Local split between practice, dispensary and ARRS budget areas.
          </SectionHeader>
