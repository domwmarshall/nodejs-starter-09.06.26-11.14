...
function App() {
  ...
  function addHolidayRequest(newRequest) {
    ...
    void logActivity({
      ...
      detail: `${newRequest.staffName} requested ${newRequest.hours} hours on ${newRequest.date}.`,
  ...
  function renderEnabledPage() {
    ...
    if (activePage === "access") {
      return <AuthPage currentUser={activeUser} />;
    }

    if (activePage === "care-navigation") {
      return <CareNavigationPage currentUser={activeUser} staffList={safeWorkforceProfiles} />;
    }
